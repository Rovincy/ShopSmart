...
const StudentsSetup = () => {
  ...
  const { data: usersData, isLoading: usersLoading } = useQuery('activeUsers', () => fetchStudentsApi('Active'));
  ...
  const columns: ColumnType<any>[] = [
    ...
    },
    {
      title: 'Semestre',
      dataIndex: 'semester',
      sorter: (a: any, b: any) => a.semester.localeCompare(b.semester),
    },
    {
      title: 'Status',
      dataIndex: 'status',
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <Space size='middle'>
          <Link to={`/StudentsSetup/editForm/`} state={record}>
