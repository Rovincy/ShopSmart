...
const DepartmentsEditForm = () => {
  ...
  var newDepartmentName:any;
  const {mutate: selectedDepartment} = useMutation((values)=>axios.put(`${Api_Endpoint}/Departments`,values), {
    onSuccess:async ()=>{
      ...
      var trailData = {
        ...
        action: `User update a department: ${departmentData.name}`,
      }
